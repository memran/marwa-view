...
/* layout.twig */
class __TwigTemplate_750b290ea77fb2243db3cc8cc4fcf5c8 extends Template
{
    ...
    <header class=\"site-header border-b border-slate-800 bg-slate-900/75 shadow-sm text-slate-100 backdrop-blur\">
        ...
        yield "
                    ...
                    <div class=\"mt-3 flex flex-wrap gap-2\">
                        <a href=\"";
        // line 47
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("_theme_home_url", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["_theme_home_url"]) || array_key_exists("_theme_home_url", $context) ? $context["_theme_home_url"] : (function () { throw new RuntimeError('Variable "_theme_home_url" does not exist.', 47, $this->source); })()), "switch-theme.php")) : ("switch-theme.php")), "html", null, true);
        yield "\" class=\"inline-flex items-center rounded-full border border-slate-700 bg-slate-900 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-200 hover:bg-slate-800\">
                            Theme Demo
                        </a>
                        <a href=\"";
        // line 50
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("_theme_docs_url", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["_theme_docs_url"]) || array_key_exists("_theme_docs_url", $context) ? $context["_theme_docs_url"] : (function () { throw new RuntimeError('Variable "_theme_docs_url" does not exist.', 50, $this->source); })()), "docs.php")) : ("docs.php")), "html", null, true);
        yield "\" class=\"inline-flex items-center rounded-full border border-cyan-500/30 bg-cyan-500/10 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-cyan-200 hover:bg-cyan-500/20\">
                            Browse Docs
                        </a>
                    </div>
                </div>
            ...
            <div class=\"w-full max-w-3xl rounded-[1.75rem] border border-slate-800 bg-slate-950/70 p-4 shadow-2xl shadow-black/20\">
                <div class=\"mb-3 flex items-center justify-between gap-4\">
                    ...
                    ";
        // line 63
        if ((($tmp = (isset($context["_theme_previewing"]) || array_key_exists("_theme_previewing", $context) ? $context["_theme_previewing"] : (function () { throw new RuntimeError('Variable "_theme_previewing" does not exist.', 63, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 64
            yield "                        <div class=\"text-[11px] text-amber-200\">
                            Saved: <strong>";
            // line 65
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["_theme_selected_meta"]) || array_key_exists("_theme_selected_meta", $context) ? $context["_theme_selected_meta"] : (function () { throw new RuntimeError('Variable "_theme_selected_meta" does not exist.', 65, $this->source); })()), "label", [], "any", false, false, false, 65), "html", null, true);
            yield "</strong>
                        </div>
                    ";
        }
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["_theme_catalog"]) || array_key_exists("_theme_catalog", $context) ? $context["_theme_catalog"] : (function () { throw new RuntimeError('Variable "_theme_catalog" does not exist.', 71, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["theme"]) {
            // line 72
            yield "                        <form method=\"post\" action=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("_theme_form_action", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["_theme_form_action"]) || array_key_exists("_theme_form_action", $context) ? $context["_theme_form_action"] : (function () { throw new RuntimeError('Variable "_theme_form_action" does not exist.', 72, $this->source); })()), "switch-theme.php")) : ("switch-theme.php")), "html", null, true);
            yield "\" class=\"rounded-3xl border border-slate-800 bg-slate-900 p-4\">
                            <input type=\"hidden\" name=\"theme_name\" value=\"";
            // line 73
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "name", [], "any", false, false, false, 73), "html", null, true);
            yield "\">
            ...
            // line 77
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "metadata", [], "any", false, false, false, 77), "label", [], "any", false, false, false, 77), "html", null, true);
            yield "</div>
                                        ";
            // line 78
            if ((CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "name", [], "any", false, false, false, 78) == (isset($context["_theme_name"]) || array_key_exists("_theme_name", $context) ? $context["_theme_name"] : (function () { throw new RuntimeError('Variable "_theme_name" does not exist.', 78, $this->source); })()))) {
                // line 79
            ...
            yield "                                    </div>
                                    ";
            // line 82
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "metadata", [], "any", false, false, false, 82), "description", [], "any", false, false, false, 82)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 83
                yield "                                        <div class=\"mt-2 text-sm leading-6 text-slate-400\">";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "metadata", [], "any", false, false, false, 83), "description", [], "any", false, false, false, 83), "html", null, true);
                yield "</div>
                                    ";
            }
            // line 85
            ...
            // line 86
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "name", [], "any", false, false, false, 86), "html", null, true);
            yield "</span>
                                        ";
            // line 87
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "metadata", [], "any", false, false, false, 87), "version", [], "any", false, false, false, 87)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                yield "<span class=\"rounded-full bg-slate-800 px-2 py-1\">Version: ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "metadata", [], "any", false, false, false, 87), "version", [], "any", false, false, false, 87), "html", null, true);
                yield "</span>";
            }
            // line 88
            yield "                                        ";
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "metadata", [], "any", false, false, false, 88), "author", [], "any", false, false, false, 88)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                yield "<span class=\"rounded-full bg-slate-800 px-2 py-1\">Author: ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "metadata", [], "any", false, false, false, 88), "author", [], "any", false, false, false, 88), "html", null, true);
                yield "</span>";
            }
            // line 89
            yield "                                    </div>
        ...
        yield "
                    ";
        // line 105
        if ((($tmp = (isset($context["_theme_previewing"]) || array_key_exists("_theme_previewing", $context) ? $context["_theme_previewing"] : (function () { throw new RuntimeError('Variable "_theme_previewing" does not exist.', 105, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 106
            yield "                        <form method=\"post\" action=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("_theme_form_action", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["_theme_form_action"]) || array_key_exists("_theme_form_action", $context) ? $context["_theme_form_action"] : (function () { throw new RuntimeError('Variable "_theme_form_action" does not exist.', 106, $this->source); })()), "switch-theme.php")) : ("switch-theme.php")), "html", null, true);
            yield "\" class=\"pt-1\">
...
";
    ...
    {
        return array (  281 => 119,  270 => 7,  257 => 120,  255 => 119,  247 => 113,  236 => 106,  234 => 105,  231 => 104,  211 => 89,  204 => 88,  198 => 87,  194 => 86,  191 => 85,  185 => 83,  183 => 82,  180 => 81,  176 => 79,  174 => 78,  170 => 77,  163 => 73,  158 => 72,  154 => 71,  149 => 68,  143 => 65,  140 => 64,  138 => 63,  122 => 50,  116 => 47,  110 => 44,  107 => 43,  101 => 41,  99 => 40,  96 => 39,  92 => 37,  90 => 36,  86 => 35,  62 => 14,  52 => 7,  44 => 1,);
    }
        ...
        <div class=\"mx-auto max-w-7xl px-4 py-5 flex flex-col gap-4 md:flex-row md:items-start md:justify-between\">
            <div class=\"flex items-center gap-4\">
                ...
                <div>
                    ...
                    <div class=\"mt-3 flex flex-wrap gap-2\">
                        <a href=\"{{ _theme_home_url|default('switch-theme.php') }}\" class=\"inline-flex items-center rounded-full border border-slate-700 bg-slate-900 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-200 hover:bg-slate-800\">
                            Theme Demo
                        </a>
                        <a href=\"{{ _theme_docs_url|default('docs.php') }}\" class=\"inline-flex items-center rounded-full border border-cyan-500/30 bg-cyan-500/10 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-cyan-200 hover:bg-cyan-500/20\">
                            Browse Docs
                        </a>
                    </div>
                </div>
