...
/* myhome.twig */
class __TwigTemplate_5f922c9a32abef17f5e06f4958d67f95 extends Template
{
...
echo \$view->render('dashboard', [
  ...
  ";
        // line 145
        if ((array_key_exists("exampleLinks", $context) && (isset($context["exampleLinks"]) || array_key_exists("exampleLinks", $context) ? $context["exampleLinks"] : (function () { throw new RuntimeError('Variable "exampleLinks" does not exist.', 145, $this->source); })()))) {
            // line 146
            yield "    <section id=\"browse\" class=\"mx-auto mb-16 max-w-7xl px-6 sm:px-8\">
      <div class=\"rounded-[2rem] border border-white/10 bg-slate-900/70 p-8 backdrop-blur\">
        <div class=\"flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between\">
          <div>
            ...
            <h2 class=\"mt-4 text-3xl font-extrabold tracking-tight text-white\">Jump directly to runnable example pages.</h2>
          </div>
          <a href=\"/index.php\" class=\"inline-flex items-center justify-center rounded-2xl border border-white/12 bg-white/5 px-5 py-3 text-sm font-semibold text-slate-100 transition hover:bg-white/10\">
            Open Root Browser
          </a>
        </div>
        ...
        <div class=\"mt-8 grid gap-4 lg:grid-cols-2\">
          ";
            ...
            $context['_seq'] = CoreExtension::ensureTraversable((isset($context["exampleLinks"]) || array_key_exists("exampleLinks", $context) ? $context["exampleLinks"] : (function () { throw new RuntimeError('Variable "exampleLinks" does not exist.', 161, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["link"]) {
                // line 162
                yield "            <a href=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["link"], "href", [], "any", false, false, false, 162), "html", null, true);
                yield "\" class=\"block rounded-3xl border border-white/10 bg-white/5 p-5 transition hover:border-brand-300/40 hover:bg-white/8\">
              <div class=\"text-lg font-semibold text-white\">";
                // line 163
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["link"], "label", [], "any", false, false, false, 163), "html", null, true);
                yield "</div>
              <p class=\"mt-2 text-sm leading-7 text-slate-400\">";
                // line 164
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["link"], "summary", [], "any", false, false, false, 164), "html", null, true);
                yield "</p>
              <div class=\"mt-4 rounded-2xl bg-slate-950 px-4 py-3 text-xs font-mono text-slate-200\">
                ";
                // line 166
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["link"], "href", [], "any", false, false, false, 166), "html", null, true);
                yield "
              </div>
            </a>
          ";
  ...
  ";
    ...
    {
        return array (  275 => 170,  265 => 166,  260 => 164,  256 => 163,  251 => 162,  247 => 161,  230 => 146,  228 => 145,  219 => 139,  215 => 138,  211 => 137,  207 => 136,  166 => 97,  164 => 93,  161 => 92,  159 => 88,  156 => 87,  154 => 83,  126 => 61,  73 => 7,  66 => 6,  55 => 4,  50 => 1,  48 => 2,  41 => 1,);
    }
...
echo \$view->render('dashboard', [
  ...
  {% if exampleLinks is defined and exampleLinks %}
    <section id=\"browse\" class=\"mx-auto mb-16 max-w-7xl px-6 sm:px-8\">
      <div class=\"rounded-[2rem] border border-white/10 bg-slate-900/70 p-8 backdrop-blur\">
        <div class=\"flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between\">
          <div>
            <div class=\"inline-flex rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-semibold uppercase tracking-[0.24em] text-brand-100\">
        ...
        <div class=\"mt-8 grid gap-4 lg:grid-cols-2\">
          {% for link in exampleLinks %}
            <a href=\"{{ link.href }}\" class=\"block rounded-3xl border border-white/10 bg-white/5 p-5 transition hover:border-brand-300/40 hover:bg-white/8\">
              <div class=\"text-lg font-semibold text-white\">{{ link.label }}</div>
              <p class=\"mt-2 text-sm leading-7 text-slate-400\">{{ link.summary }}</p>
              <div class=\"mt-4 rounded-2xl bg-slate-950 px-4 py-3 text-xs font-mono text-slate-200\">
                {{ link.href }}
              </div>
            </a>
