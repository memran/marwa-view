...
/* full-demo.twig */
class __TwigTemplate_ddae79ec4bfc128fe82cba99108a34a7 extends Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["client"]) {
            ...
            yield "</td>
                  <td class=\"px-4 py-3\">
                    <span class=\"";
            // line 122
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Marwa\View\Extension\HtmlExtension']->classNames("rounded-full px-2.5 py-1 text-xs font-semibold", (((($tmp = CoreExtension::getAttribute($this->env, $this->source,             // line 124
$context["client"], "active", [], "any", false, false, false, 124)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("bg-emerald-500/10 text-emerald-300") : ("bg-slate-700/70 text-slate-300"))), "html", null, true);
            // line 125
            yield "\">
                      ";
            // line 126
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["client"], "active", [], "any", false, false, false, 126)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Active") : ("Inactive"));
            yield "
                    </span>
                  </td>
                  <td class=\"px-4 py-3 text-right font-mono text-slate-300\">
                    ";
            // line 130
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Marwa\View\Extension\MoneyExtension']->formatMoney(CoreExtension::getAttribute($this->env, $this->source, $context["client"], "revenue_monthly", [], "any", false, false, false, 130), "USD"), "html", null, true);
            yield "
                  </td>
                </tr>
              ";
        ...
        // line 146
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Marwa\View\Extension\MoneyExtension']->formatMoney((isset($context["total"]) || array_key_exists("total", $context) ? $context["total"] : (function () { throw new RuntimeError('Variable "total" does not exist.', 146, $this->source); })()), "USD"), "html", null, true);
        yield "</strong>
          </p>
        </section>
        ...
        <section class=\"rounded-[2rem] border border-white/10 bg-slate-900/70 p-6 backdrop-blur\">
          ...
          ";
        // line 154
        $context["welcome"] = ("hello " . ((CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "name", [], "any", true, true, false, 154)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 154, $this->source); })()), "name", [], "any", false, false, false, 154), "friend")) : ("friend")));
        // line 155
        yield "          ";
        $context["shout"] = mb_strtoupper((isset($context["welcome"]) || array_key_exists("welcome", $context) ? $context["welcome"] : (function () { throw new RuntimeError('Variable "welcome" does not exist.', 155, $this->source); })()));
        // line 156
        yield "
          <div class=\"mt-4 rounded-3xl bg-slate-950/70 p-5 font-mono text-xs leading-7 text-slate-200\">
            welcome = \"";
        // line 158
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["welcome"]) || array_key_exists("welcome", $context) ? $context["welcome"] : (function () { throw new RuntimeError('Variable "welcome" does not exist.', 158, $this->source); })()), "html", null, true);
        yield "\"<br>
            shout   = \"";
        // line 159
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["shout"]) || array_key_exists("shout", $context) ? $context["shout"] : (function () { throw new RuntimeError('Variable "shout" does not exist.', 159, $this->source); })()), "html", null, true);
        yield "\"<br>
            length  = ";
        // line 160
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["welcome"]) || array_key_exists("welcome", $context) ? $context["welcome"] : (function () { throw new RuntimeError('Variable "welcome" does not exist.', 160, $this->source); })())), "html", null, true);
        yield " chars<br>
            now     = ";
        // line 161
      ...
      <div class=\"space-y-6\">
        <section class=\"rounded-[2rem] border border-white/10 bg-slate-900/70 p-6 backdrop-blur\">
          ...
          <div class=\"mt-4\">
            ";
        // line 171
        yield $this->env->getFunction('view')->getCallable()("@Blog/teaser", ["appName" => (isset($context["appName"]) || array_key_exists("appName", $context) ? $context["appName"] : (function () { throw new RuntimeError('Variable "appName" does not exist.', 171, $this->source); })())]);
        yield "
          </div>
        </section>
        ...
        <section class=\"rounded-[2rem] border border-white/10 bg-slate-900/70 p-6 backdrop-blur\">
          ...
          <div class=\"mt-5 rounded-3xl bg-slate-950/50 p-4 text-xs text-slate-400\">
            ";
        // line 183
        yield $this->extensions['Marwa\View\Extension\JsonExtension']->scriptTag("demo-state", ["app" =>         // line 184
(isset($context["appName"]) || array_key_exists("appName", $context) ? $context["appName"] : (function () { throw new RuntimeError('Variable "appName" does not exist.', 184, $this->source); })()), "user" => ["id" => CoreExtension::getAttribute($this->env, $this->source,         // line 185
(isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 185, $this->source); })()), "id", [], "any", false, false, false, 185), "role" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 185, $this->source); })()), "role", [], "any", false, false, false, 185)], "clientCount" => Twig\Extension\CoreExtension::length($this->env->getCharset(),         // line 186
(isset($context["clients"]) || array_key_exists("clients", $context) ? $context["clients"] : (function () { throw new RuntimeError('Variable "clients" does not exist.', 186, $this->source); })()))]);
        // line 187
        yield "
    ...
    ";
      ...
      ";
        // line 200
        yield from $this->load("partials/footer.twig", 200)->unwrap()->yield($context);
        // line 201
        yield "    </footer>
...
";
    ...
    {
        return array (  397 => 201,  395 => 200,  392 => 199,  390 => 198,  388 => 197,  377 => 187,  375 => 186,  374 => 185,  373 => 184,  372 => 183,  357 => 171,  344 => 161,  340 => 160,  336 => 159,  332 => 158,  328 => 156,  325 => 155,  323 => 154,  312 => 146,  304 => 140,  293 => 134,  291 => 133,  275 => 130,  268 => 126,  265 => 125,  263 => 124,  262 => 122,  257 => 120,  253 => 119,  250 => 118,  232 => 117,  210 => 97,  204 => 93,  198 => 89,  196 => 88,  191 => 85,  189 => 84,  176 => 74,  172 => 73,  166 => 70,  160 => 69,  150 => 62,  143 => 58,  136 => 54,  115 => 35,  109 => 34,  106 => 33,  101 => 32,  99 => 31,  93 => 29,  90 => 26,  84 => 24,  77 => 21,  74 => 20,  71 => 19,  64 => 18,  52 => 16,  41 => 14,);
    }
